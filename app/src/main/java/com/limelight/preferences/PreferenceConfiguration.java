...
public class PreferenceConfiguration {
    ...
    private static final String VIRTUAL_MOUSE_PREF_STRING = "checkbox_show_virtual_mouse";
    ...
    private static final boolean VIRTUAL_MOUSE_DEFAULT = false;
    ...
    public boolean showVirtualMouse;
    ...
    public static PreferenceConfiguration readPreferences(Context context) {
        ...
        config.showVirtualMouse = prefs.getBoolean(VIRTUAL_MOUSE_PREF_STRING, VIRTUAL_MOUSE_DEFAULT);
